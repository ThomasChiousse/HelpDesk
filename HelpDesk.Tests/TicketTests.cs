...
namespace HelpDesk.Tests
{
    public class TicketTests
    {
        ...
        [Fact]
        public void AdvanceStatus_WhenClosed_ShouldThrowInvalidOperationException()
        {
            // arrange
            var ticket = CreateTicket();
            ticket.AdvanceStatus(); // open -> in progress
            ...
            // act + assert
            Assert.Throws<InvalidOperationException>(() => ticket.AdvanceStatus());
        }
        ...
        [Fact]
        public void AddComment_WhenTicketIsClosed_ShouldThrowInvalidOperationException()
        {
            Comment comment = new(1, new User(2, "Thomas", "Banana", "email@domain.com", UserRole.Technician), "content");
            Ticket ticket = CreateTicket();
            ticket.AdvanceStatus(); // open -> in progress
            ...
            Assert.Throws<InvalidOperationException>(() => ticket.AddComment(comment));
